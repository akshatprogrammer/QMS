            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="post">
                    ...
                    <div class="alert alert-danger" id="error" style="margin-top: 10px; display: none;">
                        <strong>Invalid!</strong> Username already Taken.
                    </div>
...
if (isset($_POST['submit1'])) {
    $count=0;
    $res = mysqli_query($link,"select * from admin where username='$_POST[username]'");
    ...
    if($count>0){
        ...
        mysqli_query($link,"insert into admin values (NULL,'$_POST[username]','$_POST[pass]')");
        ?>
            <script type="text/javascript">
